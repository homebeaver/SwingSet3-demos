...
//        mapKit.getMainMap().addMouseMotionListener(new MouseMotionListener() {
    ...
    private RoutePainter routePainter = new RoutePainter(track);
	...
	private static final Map<String, GeoPosition> nameToGeoPosition = new HashMap<>(){
        {
            ...
            put("Madeira (Trail)",   new GeoPosition(32.81, -17.141));
        }
    };

    private static final List<GeoPosition> track = Arrays.asList(
