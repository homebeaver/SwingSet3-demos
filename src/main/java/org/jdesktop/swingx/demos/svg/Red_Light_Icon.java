 ...
 */
public class Red_Light_Icon implements RadianceIcon {
...
generalPath.closePath();
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(240, 0, 0, 255)) : new Color(240, 0, 0, 255);
g.setPaint(paint);
g.fill(shape);
g.setTransform(transformsStack.pop());
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       Red_Light_Icon base = new Red_Light_Icon();
       base.width = width;
       base.height = height;
       return base;
    }
