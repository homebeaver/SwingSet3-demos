 ...
 */
public class FlagSE implements RadianceIcon {
...
transformsStack.push(g.getTransform());
g.transform(new AffineTransform(0.0625f, 0.0f, 0.0f, 0.0625f, -0.0f, 0.1875f));
// _0
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
transformsStack.push(g.getTransform());
...
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 106, 167, 255)) : new Color(0, 106, 167, 255);
g.setPaint(paint);
g.fill(shape);
...
generalPath.closePath();
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(254, 204, 0, 255)) : new Color(254, 204, 0, 255);
g.setPaint(paint);
g.fill(shape);
g.setTransform(transformsStack.pop());
g.setTransform(transformsStack.pop());
