 ...
 */
public class CircleFlagCZ implements RadianceIcon {
...
generalPath.lineTo(247.0f, 301.2f);
...
generalPath.moveTo(210.0f, 256.0f);
generalPath.lineTo(512.0f, 256.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagCZ base = new CircleFlagCZ();
       base.width = width;
       base.height = height;
       return base;
    }
