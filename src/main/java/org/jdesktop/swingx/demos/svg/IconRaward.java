 ...
 */
public class IconRaward implements RadianceIcon {
...
shape = new Ellipse2D.Double(5.0, 1.0, 14.0, 14.0);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
generalPath.moveTo(8.21f, 13.89f);
generalPath.lineTo(7.0f, 23.0f);
generalPath.lineTo(12.0f, 20.0f);
generalPath.lineTo(17.0f, 23.0f);
generalPath.lineTo(15.79f, 13.88f);
shape = generalPath;
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       IconRaward base = new IconRaward();
       base.width = width;
       base.height = height;
       return base;
    }
