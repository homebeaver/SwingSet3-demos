 ...
 */
public class CircleFlagDE implements RadianceIcon {
...
generalPath.lineTo(256.7f, 319.5f);
...
generalPath.lineTo(255.0f, 144.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagDE base = new CircleFlagDE();
       base.width = width;
       base.height = height;
       return base;
    }
