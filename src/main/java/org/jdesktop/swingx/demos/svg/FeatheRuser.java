 ...
 */
public class FeatheRuser implements RadianceIcon {
...
generalPath.lineTo(20.0f, 19.0f);
generalPath.curveTo(20.0f, 16.790861f, 18.209139f, 15.0f, 16.0f, 15.0f);
generalPath.lineTo(8.0f, 15.0f);
generalPath.curveTo(5.790861f, 15.0f, 4.0f, 16.790861f, 4.0f, 19.0f);
generalPath.lineTo(4.0f, 21.0f);
shape = generalPath;
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Ellipse2D.Double(8.0, 3.0, 8.0, 8.0);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       FeatheRuser base = new FeatheRuser();
       base.width = width;
       base.height = height;
       return base;
    }
