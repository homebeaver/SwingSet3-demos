 ...
 */
public class IconRchevron implements RadianceIcon {
...
generalPath.moveTo(18.0f, 15.0f);
generalPath.lineTo(12.0f, 9.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       IconRchevron base = new IconRchevron();
       base.width = width;
       base.height = height;
       return base;
    }
