 ...
 */
public class CircleFlagFR implements RadianceIcon {
...
generalPath.moveTo(167.0f, 0.0f);
generalPath.lineTo(345.0f, 0.0f);
generalPath.lineTo(370.9f, 252.3f);
generalPath.lineTo(345.0f, 512.0f);
generalPath.lineTo(167.0f, 512.0f);
generalPath.lineTo(137.2f, 258.6f);
...
generalPath.moveTo(345.0f, 0.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagFR base = new CircleFlagFR();
       base.width = width;
       base.height = height;
       return base;
    }
