 ...
 */
public class CircleFlagNL implements RadianceIcon {
...
generalPath.moveTo(0.0f, 167.0f);
generalPath.lineTo(253.8f, 147.7f);
generalPath.lineTo(512.0f, 167.0f);
generalPath.lineTo(512.0f, 345.0f);
generalPath.lineTo(257.1f, 377.3f);
generalPath.lineTo(0.0f, 345.0f);
...
generalPath.lineTo(512.0f, 167.0f);
generalPath.lineTo(0.0f, 167.0f);
generalPath.closePath();
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(162, 0, 29, 255)) : new Color(162, 0, 29, 255);
g.setPaint(paint);
g.fill(shape);
g.setTransform(transformsStack.pop());
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
...
generalPath.moveTo(0.0f, 345.0f);
generalPath.lineTo(512.0f, 345.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagNL base = new CircleFlagNL();
       base.width = width;
       base.height = height;
       return base;
    }
