 ...
 */
public class FeatheRminus_circle implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       FeatheRminus_circle base = new FeatheRminus_circle();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return FeatheRminus_circle::new;
    }
}
