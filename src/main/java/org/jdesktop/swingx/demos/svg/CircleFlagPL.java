 ...
 */
public class CircleFlagPL implements RadianceIcon {
...
generalPath.moveTo(0.0f, 256.0f);
generalPath.lineTo(256.4f, 211.7f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagPL base = new CircleFlagPL();
       base.width = width;
       base.height = height;
       return base;
    }
