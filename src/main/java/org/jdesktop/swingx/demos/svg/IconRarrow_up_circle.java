 ...
 */
public class IconRarrow_up_circle implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       IconRarrow_up_circle base = new IconRarrow_up_circle();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return IconRarrow_up_circle::new;
    }
}
