 ...
 */
public class CircleFlagUA implements RadianceIcon {
...
generalPath.lineTo(258.0f, 216.6f);
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       CircleFlagUA base = new CircleFlagUA();
       base.width = width;
       base.height = height;
       return base;
    }
