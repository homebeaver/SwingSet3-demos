 ...
 */
public class IconRarchive implements RadianceIcon {
...
generalPath.moveTo(21.0f, 8.0f);
generalPath.lineTo(21.0f, 21.0f);
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(1.0, 3.0, 22.0, 5.0);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(10.000000f,12.000000f,14.000000f,12.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       IconRarchive base = new IconRarchive();
       base.width = width;
       base.height = height;
       return base;
    }
