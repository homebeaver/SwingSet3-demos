 ...
 */
public class IconRchevrons implements RadianceIcon {
...
//            g2d.rotate(getRotation(), x+this.getOrigWidth()/2, y+this.getOrigHeight()/2);
        }
		g2d.translate(x, y);
    ...
    public static RadianceIcon of(int width, int height) {
       IconRchevrons base = new IconRchevrons();
       base.width = width;
       base.height = height;
       return base;
    }
