 ...
 */
public class ic_home_black_24px implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       ic_home_black_24px base = new ic_home_black_24px();
       base.width = width;
       base.height = height;
       return base;
    }
