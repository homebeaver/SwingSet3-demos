 ...
 */
public class ic_add_circle_black_24px implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private ic_add_circle_black_24px() {
    ...
    public static RadianceIcon of(int width, int height) {
       ic_add_circle_black_24px base = new ic_add_circle_black_24px();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return ic_add_circle_black_24px::new;
    }
}
