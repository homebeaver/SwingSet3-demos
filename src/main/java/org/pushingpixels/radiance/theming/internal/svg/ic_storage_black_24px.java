 ...
 */
public class ic_storage_black_24px implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       ic_storage_black_24px base = new ic_storage_black_24px();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return ic_storage_black_24px::new;
    }
}
