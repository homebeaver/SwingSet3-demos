 ...
 */
public class keyboard_capslock_24px implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private keyboard_capslock_24px() {
    ...
    public static RadianceIcon of(int width, int height) {
       keyboard_capslock_24px base = new keyboard_capslock_24px();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return keyboard_capslock_24px::new;
    }
}
